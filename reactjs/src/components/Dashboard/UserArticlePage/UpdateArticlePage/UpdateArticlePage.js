...
import style from "./UpdateArticlePage.module.css";
...
class UpdateArticlePage extends React.Component{
    ...
    componentDidMount() {
        if (this.state.image && !this.state.field.avatar){
    ...
    async sendData(formData) {
        Axios.put(/*'https://api.mocki.io/v1/6910a074*/'/blogger/article', formData, {
            headers: {
